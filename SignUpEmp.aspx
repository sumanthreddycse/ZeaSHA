<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SignUpEmp.aspx.cs" Inherits="SignUpEmp" %>
...
<body style="background-image: url('Images/Emp2.png'); width:100%; height:100%;">
    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <div class="center-page">
            ...
            <asp:Button ID="btSignup" runat="server" Class="btn btn-success" Text="Sign Up" OnClick="btSignup_Click" />
                <asp:Label ID="Labelemp" runat="server"></asp:Label>
                </div>
